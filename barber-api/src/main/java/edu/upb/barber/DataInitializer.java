...
//            jdbcTemplate.update(
//                    "insert into empresa (id, nombre, razon_social, nit, telefono, email, activo, created_by, modified_by, created_date, modified_date, version, tipo) " +
//                            "values (gen_random_uuid(), ?, ?, ?, ?, ?, true, 'ADMIN', 'ADMIN', now(), now(), 0, 'BARBERIA')",
...
//            jdbcTemplate.update(
//                    "insert into sucursal (id, empresa_id, nombre, direccion, telefono, zona_horaria, activo, created_by, modified_by, created_date, modified_date, version) " +
