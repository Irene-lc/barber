...
import edu.upb.barber.quartz.config.PersistableCronTriggerFactoryBean;
import edu.upb.barber.quartz.config.PersistableSingleTriggerFactoryBean;
...
public class JobUtil {
    public static final String GROUP_NAME = "Barber";
