...
public class SistemaA {
    ...
    public EmpresaResponseDto crearEmpresa(EmpresaRequestDto request, String token) throws Exception {
        RestClient restClient = create();
    ...
    public EmpresaResponseDto actualizarEmpresa(String id, EmpresaRequestDto request, String token) throws Exception {
        RestClient restClient = create();
