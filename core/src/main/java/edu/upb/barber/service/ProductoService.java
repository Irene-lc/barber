...
public class ProductoService {
    ...
    public Page<ProductoResponseDto> listarPaginado(String nombre, String empresaId, Boolean activo, Pageable pageable) {
        return productoRepository.findByFilters(nombre, empresaId, activo, pageable)
